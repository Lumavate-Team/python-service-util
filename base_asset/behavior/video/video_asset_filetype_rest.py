...
from .video_filetype_category_rest import VideoFileTypeCategoryRestBehavior
from lumavate_exceptions import ValidationException

class VideoAssetFileTypeRestBehavior(AssetFileTypeRestBehavior):
  def __init__(self, model_class=VideoAssetVideoCategoryModel, data=None, category_type='filetype'):
  ...
  def set_asset_filetype(self, asset_id, filetype):
    ...
    tag = VideoFileTypeCategoryRestBehavior().get_tag_by_name(filetype)
    if not tag:
