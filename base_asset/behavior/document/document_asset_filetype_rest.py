...
from .document_filetype_category_rest import DocumentFileTypeCategoryRestBehavior
from lumavate_exceptions import ValidationException

class DocumentAssetFileTypeRestBehavior(AssetFileTypeRestBehavior):
  def __init__(self, model_class=DocumentAssetDocumentCategoryModel, data=None, category_type='filetype'):
  ...
  def set_asset_filetype(self, asset_id, filetype):
    ...
    tag = DocumentFileTypeCategoryRestBehavior().get_tag_by_name(filetype)
    if not tag:
