...
from .image_category_rest import ImageCategoryRestBehavior
from lumavate_exceptions import ValidationException

class ImageTagRestBehavior(TagRestBehavior):
  def __init__(self, model_class=ImageCategoryModel, data=None):
  ...
  def batch_tags(self):
    ...
    for tag in data:
      ...
      tag['type'] = 'tag'
      handler = ImageCategoryRestBehavior(data=tag, category_type='tag')
